...
public class FN_CheckIfEnemyInCombatRange_AllNauts
    extends Script
{
    ...
    public void onTick() {
        ...
        if (checkClass(Targetself.Self, "Hunter")) {
            if ((isUpgradeEnabled(Yesno.Yes, "HunterShotDamage3")||isUpgradeEnabled(Yesno.Yes, "HunterShotDamage4"))||isUpgradeEnabled(Yesno.Yes, "HunterShotHero2")) {
                // in range
                if (isTargetInArea(Yesno.Yes, 0.25D, 0.0D, 0.4D, 0.1D, Yesno.No, Yesno.No)) {
                    setBool("EnemyIsInCombatRange", Flagtoggle.Yes);
                }
                ...
                // in range
                if (isTargetInArea(Yesno.Yes, 0.3D, 0.0D, 0.45D, 0.1D, Yesno.No, Yesno.No)) {
                    setBool("EnemyIsInCombatRange", Flagtoggle.Yes);
                }
            }
        }
        if (checkClass(Targetself.Self, "Maw")) {
            // in range
            if (isTargetInArea(Yesno.Yes, 0.05D, 0.0D, 0.07D, 0.13D, Yesno.No, Yesno.No)) {
                setBool("EnemyIsInCombatRange", Flagtoggle.Yes);
            }
        }
