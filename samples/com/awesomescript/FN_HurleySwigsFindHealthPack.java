...
public class FN_HurleySwigsFindHealthPack
    extends Script
{
                ...
                if (isInNamedArea("AREABOTTOM", Ownenemy.OWN_TEAM, Targetself.Self)) {
                    ...
                    if (isInNamedArea("AREACENTER", Ownenemy.OWN_TEAM, Targetself.Self)) {
                        if (isPickupAtWaypoint("CENTERHP", Ownenemy.OWN_TEAM)) {
                            if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.PLAYERS), Yesno.No, Yesno.Yes, EnumSet.of(Teams.ENEMY_TEAM), "", 0.0D, 0.0D, 0.35D, 0.35D, Yesno.No, Yesno.No)||checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 40.0D, Valuecompare.Greater, Targetself.Self)) {
