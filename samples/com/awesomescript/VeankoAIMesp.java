    ...
    extends Script
{
    ...
    public void onTick() {
        ...
        // prevent bots from getting stuck in soronas jungle
        if (isInNamedArea("JUNGLE", Ownenemy.OWN_TEAM, Targetself.Self)) {
            if (isInNamedArea("DROP_WARNING", Ownenemy.OWN_TEAM, Targetself.Self)) {
            } else {
                if (timer(Timeunits.Seconds, 1.0D, Yesno.No)) {
                    // check for walls
                    if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.INVINCIBLE_OBSTACLES), Yesno.No, Yesno.Yes, EnumSet.of(Teams.OWN_TEAM, Teams.ENEMY_TEAM, Teams.NEUTRAL_TEAM), "", 0.04D, 0.0D, 0.16D, 0.05D, Yesno.No, Yesno.No)) {
        ...
        // dont dance around and do nothing while they are attacking your base!
        if (isInNamedArea("HEALAREACLOSE", Ownenemy.OWN_TEAM, Targetself.Self)) {
        ...
        executeBehaviourTree("VeankoLookingForHealthPacks");
        ...
        if (checkCharacterValue(CharactervaluesCheckable.AISkill, 0.3D, Valuecompare.Greater, Targetself.Self)) {
            executeBehaviourTree("VeankoStatusChecker");
        }
        ...
        // dont try to get into the enemys heal area
        if (isInNamedArea("AREAHOME", Ownenemy.ENEMY_TEAM, Targetself.Self)) {
            if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.DESTROYABLE_OBSTACLES), Yesno.No, Yesno.Yes, EnumSet.of(Teams.ENEMY_TEAM), "", 0.0D, -0.7D, 0.7D, 0.2D, Yesno.No, Yesno.No)) {
                if (directionToEnemyBase(Forwardbackward.FORWARD)) {
            ...
            // dont run back into droppod area
        ...
        if (getBoolEquals("neverdetectStealth", Yesno.No)) {
            ...
            if (checkCharacterValue(CharactervaluesCheckable.AISkill, 0.3D, Valuecompare.Greater, Targetself.Self)) {
                if (getBoolEquals("DetectedStealth", Yesno.No)) {
                    ...
                    if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.PLAYERS), Yesno.No, Yesno.Yes, EnumSet.of(Teams.ENEMY_TEAM), "", 0.0D, 0.0D, 0.2D, 0.2D, Yesno.Yes, Yesno.Yes)) {
                        ...
                        if (checkCharacterValue(CharactervaluesCheckable.AISkill, 0.5D, Valuecompare.Greater, Targetself.Self)) {
                            ...
                            if (timer(Timeunits.Seconds, 0.25D, Yesno.No)) {
                                if (random("2")) {
                                    setBool("DetectedStealth", Flagtoggle.Yes);
                                    selectTarget(EnumSet.of(TargetGroups.PLAYERS), EnumSet.of(Teams.ENEMY_TEAM), "", Yesno.No, Yesno.No, 0.0D, 0.0D, 0.2D, 0.2D, Valuecompare2 .GreaterOrEqual, 0.0D, DistanceCheck.CLOSEST, Yesno.Yes, Yesno.Yes);
                                }
                            }
        ...
        if (getBoolEquals("nopushfix", Yesno.No)) {
            if (isTargetType(Yesno.Yes, EnumSet.of(TargetGroups.CREEPS, TargetGroups.DESTROYABLE_OBSTACLES))) {
                if (checkCounter("state", "4", Valuecompare.Equal)||checkCounter("state", "8", Valuecompare.Equal)) {
                    ...
                    if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.CREEPS, CollisonGroups.DESTROYABLE_OBSTACLES), Yesno.No, Yesno.Yes, EnumSet.of(Teams.ENEMY_TEAM), "", 0.0D, 0.0D, 0.24D, 0.1D, Yesno.Yes, Yesno.No)) {
                    ...
                    if (isTargetInArea(Yesno.Yes, 0.0D, 0.0D, 0.4D, 0.1D, Yesno.Yes, Yesno.No)) {
                        if (isSkillOnButtonAvailable(Buttons.FACE_LEFT)) {
        ...
        if (getBoolEquals("false", Yesno.No)) {
                ...
                if (getBoolEquals("Combat", Yesno.No)) {
                    ...
                    if (isTargetInArea(Yesno.Yes, 0.0D, 0.0D, 3.0D, 3.0D, Yesno.Yes, Yesno.No)) {
                        ...
                        if (isTargetInArea(Yesno.No, 0.0D, 0.0D, 0.55D, 0.55D, Yesno.Yes, Yesno.No)) {
                            ...
                            executeBehaviourTree("VeankoMespCheckIfEnemyTooClose");
                            if (getBoolEquals("EnemyIsTooClose", Yesno.Yes)||getBoolEquals("backOff", Yesno.Yes)) {
                                ...
                                executeBehaviourTree("VeankoMespCheckIfEnemyInCombatRange");
            ...
            if (checkCounter("state", "5", Valuecompare.Equal)) {
                ...
                if ((isAtDestWaypoint()||isInNamedArea("JUNGLE", Ownenemy.OWN_TEAM, Targetself.Self))||isInNamedArea("JUNGLE", Ownenemy.ENEMY_TEAM, Targetself.Self)) {
                    if (isCharacterInArea(EnumSet.of(TargetReceiveGroups.CREEPS), EnumSet.of(Teams.NEUTRAL_TEAM), "", Yesno.No, Yesno.No, Yesno.Yes, CharactervaluesCheckable.Health, Valuecompare.Less, 200.0D, "", 0.0D, 0.0D, 2.0D, 1.0D, Yesno.No)||isCharacterInArea(EnumSet.of(TargetReceiveGroups.CREEPS), EnumSet.of(Teams.NEUTRAL_TEAM), "", Yesno.No, Yesno.No, Yesno.Yes, CharactervaluesCheckable.Health, Valuecompare.Less, 200.0D, "", -1.0D, 0.0D, 2.0D, 1.0D, Yesno.No)) {
                        // get em
                        selectTarget(EnumSet.of(TargetGroups.CREEPS), EnumSet.of(Teams.NEUTRAL_TEAM), "", Yesno.No, Yesno.No, 0.0D, 0.0D, 2.0D, 1.0D, Valuecompare2 .Less, 200.0D, DistanceCheck.CLOSEST, Yesno.No, Yesno.No);
                        if (hasTarget(Yesno.Yes)) {
                            // chaseBattle (4)
                            adjustCounter("setState", "4", Valueadjust.Set);
                        } else {
                            ...
                            if (areGoldCoinsInArea(3.0D, Valuecompare.GreaterOrEqual, 0.0D, -0.05D, 0.8D, 0.15D, Yesno.Yes)) {
                                if ((isInNamedArea("NEAR_WORM_AREA", Ownenemy.OWN_TEAM, Targetself.Self)||isInNamedArea("NEAR_WORM_AREA", Ownenemy.ENEMY_TEAM, Targetself.Self))||isInNamedArea("WORM_AREA", Ownenemy.OWN_TEAM, Targetself.Self)) {
                                } else {
                                    // collect MONAY (9)
                                    adjustCounter("setState", "9", Valueadjust.Set);
                                }
            ...
            if (checkCounter("state", "8", Valuecompare.Equal)) {
                ...
                if (isTargetPosition(Yesno.Yes, Offsetposition.BACK)) {
                    ...
                    if (getBoolEquals("isTank", Yesno.No)) {
                        // creeps in front
                        if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.CREEPS), Yesno.No, Yesno.Yes, EnumSet.of(Teams.OWN_TEAM), "", 0.59D, 0.0D, 0.8D, 1.0D, Yesno.Yes, Yesno.No)) {
                            executeBehaviourTree("VeankoMespCheckIfEnemyInCombatRange");
                            // in range
            ...
            if (checkCounter("state", "10", Valuecompare.Equal)) {
                ...
                if (((isInNamedArea("AREACENTER", Ownenemy.OWN_TEAM, Targetself.Self)||isInNamedArea("AREACENTERBOTTOM", Ownenemy.OWN_TEAM, Targetself.Self))||isInNamedArea("AREAUPPER", Ownenemy.OWN_TEAM, Targetself.Self))||isInNamedArea("AREABOTTOM", Ownenemy.OWN_TEAM, Targetself.Self)) {
                    // healthy?
                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 60.0D, Valuecompare.Greater, Targetself.Self)) {
                        // can't be one-shotted by spike dive
                        if (getBoolEquals("spikediveDeath", Yesno.No)) {
                            // advanceToFrontline (3)
                            adjustCounter("setState", "3", Valueadjust.Set);
                        }
        ...
        if (checkCharacterValue(CharactervaluesCheckable.AISkill, 0.5D, Valuecompare.Greater, Targetself.Self)) {
            ...
            if (doesClassExist(EnumSet.of(Teams.ENEMY_TEAM), "Heavy")) {
                if (hasUpgrade("Heavy", Teamswithnumbers.ENEMY_TEAM, "SIEGEMODEON")) {
                    if (isCharacterInArea(EnumSet.of(TargetReceiveGroups.PLAYERS), EnumSet.of(Teams.ENEMY_TEAM), "Heavy", Yesno.No, Yesno.No, Yesno.Yes, CharactervaluesCheckable.HealthPercentage, Valuecompare.Greater, 30.0D, "", 0.0D, 0.0D, 1.8D, 1.0D, Yesno.Yes)) {
                        if (isInArea(Yesno.No, EnumSet.of(CollisonGroups.DESTROYABLE_OBSTACLES), Yesno.No, Yesno.Yes, EnumSet.of(Teams.OWN_TEAM), "", 0.0D, 0.0D, 1.8D, 1.0D, Yesno.No, Yesno.No)||directionToEnemyBase(Forwardbackward.BACKWARD)) {
                            if (isCharacterInArea(EnumSet.of(TargetReceiveGroups.PLAYERS), EnumSet.of(Teams.OWN_TEAM), "", Yesno.No, Yesno.No, Yesno.Yes, CharactervaluesCheckable.HealthPercentage, Valuecompare.GreaterOrEqual, 30.0D, "", 0.0D, 0.0D, 1.8D, 1.0D, Yesno.Yes)||isInNamedArea("AREAHOME", Ownenemy.OWN_TEAM, Targetself.Self)) {
                            } else {
                                if ((isUpgradeEnabled(Yesno.No, "TankExploding")&&isUpgradeEnabled(Yesno.No, "VampireBloodthirstOn"))&&getBoolEquals("DontRunFromNauts", Yesno.No)) {
                                    if (((checkCounter("state", "1", Valuecompare.Equal)||checkCounter("state", "6", Valuecompare.Equal))||checkCounter("state", "10", Valuecompare.Equal))||checkCounter("state", "11", Valuecompare.Equal)) {
                                    } else {
                        ...
                        if (hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdGoldInPocket")&&hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdDiveDamage2")) {
                            ...
                            if (hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdGoldInPocket")&&hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdDiveDamage")) {
                                ...
                                if (hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdDiveDamage2")) {
                                    // i can be one shotted by spike dive
                                    if (checkCharacterValue(CharactervaluesCheckable.Health, 550.0D, Valuecompare.LessOrEqual, Targetself.Self)) {
                                        // Retreat
                                        adjustCounter("setState", "1", Valueadjust.Set);
                                        setBool("spikediveDeath", Flagtoggle.Yes);
                                    }
                                    ...
                                    if (hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdGoldInPocket")) {
                                        ...
                                        if (hasUpgrade("Bird", Teamswithnumbers.ENEMY_TEAM, "BirdDiveDamage")) {
                                            // i can be one shotted by spike dive
                                            if (checkCharacterValue(CharactervaluesCheckable.Health, 450.0D, Valuecompare.LessOrEqual, Targetself.Self)) {
                                                // Retreat
                                                adjustCounter("setState", "1", Valueadjust.Set);
                                                setBool("spikediveDeath", Flagtoggle.Yes);
                                            }
                                    ...
                                    if (isNextWaypointPosition(Offsetposition.BACK)) {
                                        ...
                                        if (isNextWaypointPosition(Offsetposition.FRONT)) {
                                            ...
                                            if (isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.INVINCIBLE_OBSTACLES, CollisonGroups.DESTROYABLE_OBSTACLES), Yesno.No, Yesno.Yes, EnumSet.of(Teams.OWN_TEAM, Teams.ENEMY_TEAM, Teams.NEUTRAL_TEAM), "", 0.1D, 0.0D, 0.1D, 0.05D, Yesno.No, Yesno.No)||isInArea(Yesno.Yes, EnumSet.of(CollisonGroups.PLAYERS, CollisonGroups.CREEPS), Yesno.No, Yesno.Yes, EnumSet.of(Teams.ENEMY_TEAM, Teams.NEUTRAL_TEAM), "", 0.04D, -0.03D, 0.08D, 0.02D, Yesno.No, Yesno.Yes)) {
                                                if (getBoolEquals("Bird", Yesno.Yes)) {
                                                    setBool("GoForward", Flagtoggle.No);
                                                    // check walls
