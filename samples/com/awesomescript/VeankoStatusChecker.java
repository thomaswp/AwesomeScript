...
public class VeankoStatusChecker
    extends Script
{
    ...
    public void onTick() {
        ...
        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 91.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 81.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
            ...
            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 81.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 71.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                ...
                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 71.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 61.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                    ...
                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 61.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 51.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                        ...
                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 51.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 41.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                            ...
                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 41.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 31.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                ...
                                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 31.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 21.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                    ...
                                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 21.0D, Valuecompare.Less, Targetself.Self)) {
            ...
            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 81.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 71.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                ...
                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 71.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 61.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                    ...
                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 61.0D, Valuecompare.Less, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 51.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                        ...
                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 51.0D, Valuecompare.LessOrEqual, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 41.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                            ...
                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 41.0D, Valuecompare.LessOrEqual, Targetself.Self)&&checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 31.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
        ...
        // Used to track health loss
        if (once()) {
            adjustCounter("ten", "10", Valueadjust.Set);
        }
        // Track health
        if (timer(Timeunits.Seconds, 1.0D, Yesno.No)) {
            if (once()) {
                adjustCounter("health", "0", Valueadjust.Set);
            }
            adjustCounter("lastHealth", "health", Valueadjust.Set);
            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 100.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                adjustCounter("health", "100", Valueadjust.Set);
            } else {
                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 95.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                    adjustCounter("health", "95", Valueadjust.Set);
                } else {
                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 90.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                        adjustCounter("health", "90", Valueadjust.Set);
                    } else {
                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 85.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                            adjustCounter("health", "85", Valueadjust.Set);
                        } else {
                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 80.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                adjustCounter("health", "80", Valueadjust.Set);
                            } else {
                                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 75.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                    adjustCounter("health", "75", Valueadjust.Set);
                                } else {
                                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 70.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                        adjustCounter("health", "70", Valueadjust.Set);
                                    } else {
                                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 65.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                            adjustCounter("health", "65", Valueadjust.Set);
                                        } else {
                                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 60.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                adjustCounter("health", "60", Valueadjust.Set);
                                            } else {
                                                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 55.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                    adjustCounter("health", "55", Valueadjust.Set);
                                                } else {
                                                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 50.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                        adjustCounter("health", "50", Valueadjust.Set);
                                                    } else {
                                                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 45.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                            adjustCounter("health", "45", Valueadjust.Set);
                                                        } else {
                                                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 40.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                adjustCounter("health", "40", Valueadjust.Set);
                                                            } else {
                                                                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 35.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                    adjustCounter("health", "35", Valueadjust.Set);
                                                                } else {
                                                                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 30.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                        adjustCounter("health", "30", Valueadjust.Set);
                                                                    } else {
                                                                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 25.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                            adjustCounter("health", "25", Valueadjust.Set);
                                                                        } else {
                                                                            if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 20.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                                adjustCounter("health", "20", Valueadjust.Set);
                                                                            } else {
                                                                                if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 15.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                                    adjustCounter("health", "15", Valueadjust.Set);
                                                                                } else {
                                                                                    if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 10.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                                        adjustCounter("health", "10", Valueadjust.Set);
                                                                                    } else {
                                                                                        if (checkCharacterValue(CharactervaluesCheckable.HealthPercentage, 5.0D, Valuecompare.GreaterOrEqual, Targetself.Self)) {
                                                                                            adjustCounter("health", "5", Valueadjust.Set);
                                                                                        } else {
                                                                                            adjustCounter("health", "0", Valueadjust.Set);
                                                                                        }
                                                                                    }
